    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <form id="writeForm" action="/community/insert" enctype="multipart/form-data">
            	<input type="hidden" name="comuCateId" value="1"> 
                <div class="form-group">
                    <label for="title">제목</label>
                    <input type="text" id="title" name="title"  value="${postVO.title }" required readonly>
                </div>
                <div class="form-group">
                    <label for="writer">글쓴이</label>
                    <input type="text" id="writer" name="memId" value="${postVO.memId }" required readonly>
                </div>
                <div class="form-group">
                    <label for="content">내용</label>
                    <input type="text" id="content" name="detail" value="${postVO.detail }" required readonly></textarea>
                </div>
                <div class="form-group">
                    <label for="imgFile">이미지</label>
                    <c:forEach items="${postVO.img.split(',') }" var="img">
                    	<img src="<c:url value='/project_images/community/${img}'/>">
                    </c:forEach>
                </div>
                <div class="bt_wrap">
